...
use crate::implementations::grok_build::compass::{MapReadInput, MapUpdateInput};
use crate::implementations::grok_build::roster::{RosterAddInput, RosterListInput};
...
pub enum ToolInput {
    ...
    RosterList(RosterListInput),
    RosterAdd(RosterAddInput),
    MapUpdate(MapUpdateInput),
    MapRead(MapReadInput),
