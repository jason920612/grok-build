...
//! 2. `$GROKTOOL_HOME/managed_config.toml`
//! 3. `$GROKTOOL_HOME/config.toml`
//! 4. `$GROKTOOL_HOME/requirements.toml` (cloud cache; Ed25519-signed at rest once a
...
pub use paths::{
    HOME_ENV_VAR, PRODUCT_NAME, USER_DOT_DIR, claude_managed_settings_path,
